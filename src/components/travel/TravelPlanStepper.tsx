  ...
  return (
    ...
    >
      ...
      >
          ...
          {step === 1 && (
           ...
           {step === 3 && (
            ...
            <VStack spacing={3} align="stretch">
              ...
              <FormControl>
                <FormLabel fontWeight="bold" color="gray.700" fontSize="md" mb={2}>관심사</FormLabel>
                <CheckboxGroup
              ...
              <FormControl>
                <FormLabel fontWeight="bold" color="gray.700" fontSize="md" mb={2}>이동수단</FormLabel>
                <Select
                  size="lg"
              ...
              <FormControl isRequired>
                <FormLabel fontWeight="bold" color="gray.700" fontSize="md" mb={2}>일정 스타일</FormLabel>
                <RadioGroup
                  value={form.style}
          ...
          {/* 고급스러운 네비게이션 버튼 */}
                     <HStack justify="space-between" w="100%" pt={3}>
            <Button 
              onClick={handlePrev} 
              isDisabled={step === 1}
              size="lg"
